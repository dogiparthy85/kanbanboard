...
function MenuEditor(idSelector, options) {
    var $main = $("#" + idSelector);
    var settings = {
        labelEdit: '<i class="fa fa-fw fa-edit clickable"></i>',
        labelRemove: '<i class="fa fa-fw fa-trash-o clickable"></i>',
        ...
        listOptions: { 
            ...
            opener: {
                as: 'html',
                close: '<i class="fa fa-fw fa-minus"></i>',
                open: '<i class="fa fa-fw fa-plus"></i>',
