...
if (file_exists(APPPATH . 'config/app-config.php')) {
	//if (version_compare(PHP_VERSION, APP_MINIMUM_REQUIRED_PHP_VERSION, '<')) {
	...
	$install_url .= 'install';
	$install_url .= '?service=staff_service';
	echo '<h1>Service not installed</h1>';
	echo '<p>1. To you use the automatic Service installation tool <a href="' . $install_url . '"> click here </a></p>';
...
$config['service_name'] = 'staff_service'; // Please do not change this value manually. This value used into Staff Service
$config['installer_locked'] = (DEFINED('APP_INSTALLER_LOCKED') ? APP_INSTALLER_LOCKED : false);
